...
public class View extends JFrame implements Observer {
    ...
    private void showGameBoard() {
        ...
        mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // ==================== UC1 - ANIMATION SEQUENCE ====================
                // 1.5 paintComponent()
                drawPieceAtBarn(cellSize, g2d);      // 1.5.1 drawPieceAtBarn()
                drawPiece(cellSize, g2d);            // 1.5.2 drawPiece()
                drawHighlights(g2d, cellSize);       // 1.5.3 drawHighlights()

                // 1.6 Hiển thị trạng thái mới
            }
        };
    ...
    public void updateMove() {
        // 1.3 updateMove()
        mainPanel.repaint();   // Gọi paintComponent() → vẽ lại bàn cờ
    }
